...
function GanttView() {
  const [tasks] = useState<GanttTask[]>([
    { id: "1", name: "Project Planning", start: "2026-01-01", end: "2026-01-15", progress: 100 },
    { id: "2", name: "Design Phase", start: "2026-01-10", end: "2026-01-25", progress: 75, dependencies: ["1"] },
    { id: "3", name: "Development", start: "2026-01-20", end: "2026-02-15", progress: 50, dependencies: ["2"] },
    { id: "4", name: "Testing", start: "2026-02-10", end: "2026-02-28", progress: 25, dependencies: ["3"] },
    { id: "5", name: "Deployment", start: "2026-02-25", end: "2026-03-05", progress: 0, dependencies: ["4"] },
  ])
